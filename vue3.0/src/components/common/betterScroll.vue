    ...
    <div ref="wrapper"
        ...
        <div class="content-bg better-scroll-container">
            ...
            <div>
                ...
                <div v-if="pulldown"
                     class="pulldown-tip">
                    <i class="pull-icon indexicon icon-pull-down"
                       :class="[pulldownTip.rotate]"></i>
                    <span class="tip-content">{{pulldownTip.text}}</span>
                </div>
                <div v-show="loadingStatus.showIcon || loadingStatus.status"
                     class="loading-pos">
                    <div v-show="loadingStatus.showIcon"
            ...
            _initScroll() {
                ...
                if (this.pullup) {
                    this.scroll.on('scrollEnd', () => {
                        // 滚动到底部
                        if (this.scroll.y <= (this.scroll.maxScrollY + 50)) {
                            console.log('是否派发滚动到底部事件，用于上拉加载');
