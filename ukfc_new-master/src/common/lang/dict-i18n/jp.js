export const jaJP = {
  ...
  common: {
    ...
    invest: '投資',
    auditAssets: '審査済み資産',
    waitAuditAssets: '審査待ち資産',
    forgetSellPwd: '取引パスワードをお忘れですか？ クリックしてください',
    here: 'ここで',
    goBack: '戻る'
  },
  /* placeholder 通用 */
  ...
  sellPwdPage: {
    ...
    resetSellPwdSuccessTip: 'トランザクションパスワードのリセットに成功しました',
  ...
  changeVerifyTypeCom: {
    ...
    notBindAny: '確認方法に拘束されず、確認コードを送信できません'
  },
  // 头部组件
  headerCom: {
    assets: '資産',
  ...
  investModal: {
    ...
    investAmount: '投資金額',
    minInvestAmount: '最小投資金額',
    reservationNow: '今すぐ投資',
    reservationSuccess: '投資に成功しました！'
  },
  // 首页账户资产预约弹窗
  accountReservationModal: {
    reservationInvest: '予約',
    coinName: '通貨',
    reservationAmount: '予約額',
    futureName: '先物名',
    investAmount: '投資金額',
    minInvestAmount: '最小投資金額',
    reservationNow: '今すぐ予約',
