export const zhCN = {
  /* All the drop-down boxes and various status values are stored here */
  selectOption: {
    YesOrNo: {
      1: 'Yes',
      0: 'No',
    ...
    // Text description corresponding to way of validate code sending
    verifyTypeText: {
      email: 'Email Address Validate Code',
      mobile: 'Mobile Number Validate Code',
  ...
  // Change Verification Type Component
  changeVerifyTypeCom: {
    toggle: 'Toggle',
