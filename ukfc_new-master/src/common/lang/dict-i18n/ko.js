export const koKR = {
  ...
  common: {
    ...
    person: '사람들',
    invest: '투자',
    auditAssets: '자사심사 기완료',
    waitAuditAssets: '자산심사 대기',
    goBack: '돌아 가기'
  },
  /* placeholder 通用 */
  placeholder: {
  ...
  sellPwdPage: {
    ...
    resetSellPwdSuccessTip: '트랜잭션 암호가 성공적으로 재설정되었습니다！',
    updateSellPwdSuccessTip: '거래 비밀번호 수정 성공！',
    forgetSellPwd: '거래 비밀번호를 잊어 버리셨습니까? 클릭하십시오.',
    here: '여기에',
    resetNow: '지금 재설정'
  },
  // 设置交易密码页面
...
`
  ...
  changeVerifyTypeCom: {
    ...
    notBindAny: '어떤 인증 방법에도 구속력이없고 인증 코드를 보낼 수 없습니다.'
  },
  // 头部组件
  headerCom: {
    assets: '자산',
  ...
  // 投资弹窗
  investModal: {
    reservationInvest: '투자',
    futureName: '선물명칭',
    investAmount: '투자금액',
    minInvestAmount: '최소투자금액',
    reservationNow: '즉시 투자',
    reservationSuccess: '투자 성공！'
  },
  // 首页账户资产预约弹窗
  accountReservationModal: {
    reservationInvest: '예약',
    coinName: '통화',
    reservationAmount: '약속 금액',
    futureName: '선물명칭',
    investAmount: '투자금액',
    minInvestAmount: '최소투자금액',
    reservationNow: '즉시 투자',
