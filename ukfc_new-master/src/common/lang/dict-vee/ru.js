...
const originRuDict = {
  common: {
    ...
    geetest: {
      required: 'Нажмите кнопку, чтобы подтвердить'
    }
  },
// 注册表单  Форма рег.
  regist: {
...
// 预约投资表单  Форма брон. вложения
  ...
  accountReservationForm: {
    ...
    volume: {
      required: 'введ.сумму брон.',
      decimal: 'макс.кол.брон.двухзнач.',
      //min_value: '投资金额不能小于最小投资金额',  сумма брон.не должна быть менее мин.суммы влож.
      max_value: 'недост.средств'
    }
  }
};
...
export const
  ru_dictionary = flatDictMap_outer(originRuDict);
